...
export const ModalFooter = ({
    ...
    <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 mt-4">
        ...
        <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-gray-900 rounded-xl hover:bg-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
            {isLoading && (
