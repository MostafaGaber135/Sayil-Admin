...
import {
  AdminSection, BasicInfoSection, FeaturesSection,
  LocationSection, PropertyDetailsSection
} from "@/features/listings";
import {useEffect} from "react";
import {ListingFormValues, listingSchema} from "@/features/listings/validation";
...
export const ListingForm = ({ defaultData, onSubmit, isPending, lookups }: Props) => {
  ...
  const formProps = { register, errors, control, setValue, watch };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit, onError)} className="space-y-6">
            ...
            <Section title="Basic Information">
              <BasicInfoSection {...formProps} />
            </Section>

            <Section title="Property Details">
              <PropertyDetailsSection {...formProps} lookups={lookups} />
            </Section>

            <Section title="Property Features">
              <FeaturesSection {...formProps} />
            </Section>

            <Section title="Location Details">
              <LocationSection {...formProps} lookups={lookups} />
            </Section>

            <Section title="Administrative Information">
              <AdminSection {...formProps} lookups={lookups} />
            </Section>
