...
export const LegalDocsSection = () => {
  const { setValue, watch, formState: { errors } } = useFormContext<ListingFormValues>();
  ...
  return (
    <div className="flex items-center gap-4 p-4 border border-gray-100 rounded-xl bg-gray-50/50">
      ...
      <label className={`flex-shrink-0 px-4 py-2 text-xs font-medium rounded-lg cursor-pointer transition-colors ${
        isUploaded ? "bg-gray-100 text-gray-600 hover:bg-gray-200" : "bg-gray-900 text-white hover:bg-black"
      }`}>
